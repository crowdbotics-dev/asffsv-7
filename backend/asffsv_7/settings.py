"""
Django settings for asffsv_7 project.
...
WSGI_APPLICATION = 'asffsv_7.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asffsv_7 API",
    "DESCRIPTION": "API documentation for asffsv_7 App",
    "VERSION": "v1",
}
